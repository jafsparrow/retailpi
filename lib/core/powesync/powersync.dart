...
class TestBackendConnector extends PowerSyncBackendConnector {
  ...
  Future<PowerSyncCredentials?> fetchCredentials() {
    return Future.value(PowerSyncCredentials(
        ...
        token:
            'eyJhbGciOiJSUzI1NiIsImtpZCI6InBvd2Vyc3luYy1kZXYtMzIyM2Q0ZTMifQ..tm4lRPpsu-QhlXJ3JICn9-eZ6LQJHbfzI2GZoCPz4tIOZRUX--wg7TbNUZm2_hS0LIS6-lEcV-xjJ2d6H5050i6b4mShQQXsEZ4y11q8Hq7VHA_9vCG7SSDJ9JBlwDjsgCmI4LUY1PRTXpXGrdNjLj3kf70_9y0KuqJ5yoDB1vruh8_al9JXuKodMOVolys9lrn1mlgViFp3rB-AGSardnw2EH-A51IVivNi05TbuQvtkZ6iWi3kwXZAZs9POzmTqJNenMGhisJlwfRn401-wLXmgyt_nimTkB_gUk_2HK2glaMVs8HHnE__MST5eoVcD2d2M2_kyA_bRM9G47YqIg',
...
Future<String> getDatabasePath() async {
  const dbFilename = 'powersync-demo1.db';
